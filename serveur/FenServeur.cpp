...
FenServeur::FenServeur()
{
    ...
    else
    {
        ...
        QString a = QString("Le serveur a été démarr&eacute; sur le port <strong>") + QString::number(serveur->serverPort()) + "</strong>.<br />Des clients peuvent maintenant se connecter.";
